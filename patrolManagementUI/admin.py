...
class DQJCJL(admin.ModelAdmin):
    list_display = ['定期检查记录编号', '道路编号', '巡查人员', '巡查日期']
    list_filter = ['巡查日期','巡查人员']
    search_fields = ['定期检查记录编号', '道路编号', '巡查日期']
    # 按照什么进行排序
    # ordering = ['巡查日期']
...
class RCXXJL(admin.ModelAdmin):
    list_display = ['日常巡查记录编号', '道路编号', '巡查人员', '巡查日期']
...
class RCXCSHJL(admin.ModelAdmin):
    list_display = ['日常巡查损害记录编号','日常巡查记录编号','路面类型','损坏类型','损坏位置及情况描述']
    # list_display_links = ['日常巡查损害记录编号']
    list_filter = ['路面类型','损坏类型']
    search_fields = ['日常巡查损害记录编号','日常巡查记录编号','路面类型','损坏类型']
